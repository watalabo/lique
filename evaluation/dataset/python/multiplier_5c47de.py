# https://github.com/amitcrypto/ARIA-Blocks-Qiskit/blob/8a5e59e99b93377b152c39c521d4205713db056e/Multiplier.py
...
def create_circuit():
    ...
    circuit = QuantumCircuit(q) # ql-unmeasurable-qubits,ql-oversized-circuit
