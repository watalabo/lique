...
if __name__ == "__main__":
    ...
    lintq_results = [
        ...
        LintqResult("ql-double-measurement", "TP", "measurement_postulate_single_qubit_f_fb7a34", python.measurement_postulate_single_qubit_f_fb7a34.create_circuit),
        LintqResult("ql-double-measurement", "TP", "qubits_d78ad0", python.qubits_d78ad0.create_circuit),
        LintqResult("ql-double-measurement", "TP", "qubits_intro_974f92", python.qubits_intro_974f92.create_circuit),
        LintqResult("ql-double-measurement", "TP", "rsa_breaker_4_bit_0f27ff", python.rsa_breaker_4_bit_0f27ff.create_circuit),
        LintqResult("ql-double-measurement", "TP", "sandbox_e52934", python.sandbox_e52934.create_circuit),
        ...
        LintqResult("ql-operation-after-measurement", "TP", "_12_quantum_key_distribution_checkpoint_4165fd", python._12_quantum_key_distribution_checkpoint_4165fd.create_circuit),
        ...
        LintqResult("ql-operation-after-measurement", "TP", "hardware_3936ea", python.hardware_3936ea.create_circuit),
        ...
        LintqResult("ql-operation-after-measurement", "TP", "quantumdice_bc7351", python.quantumdice_bc7351.create_circuit),
        ...
        LintqResult("ql-operation-after-measurement", "TP", "quntum_204_dec_2005_202020_206_2042_20am_16e278", python.quntum_204_dec_2005_202020_206_2042_20am_16e278.create_circuit),
        LintqResult("ql-operation-after-measurement", "TP", "task_2_4f46b2", python.task_2_4f46b2.create_circuit),
        LintqResult("ql-operation-after-measurement", "TP", "teleportation_8f1eaf", python.teleportation_8f1eaf.create_circuit),
